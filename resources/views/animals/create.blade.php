...
<body>
    <div class="container">
        <form action="{{route('create-animal')}}" method="post" class="card p-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3 mt-3">
                <label for="qr_id" class="form-label">qr_id:</label>
                <input type="text" class="form-control" value="{{$id}}" name="qr_id" >
            </div>
            <div class="mb-3 mt-3">
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="file" class="form-control" class="profile" placeholder="Profile" name="profile">
            </div>
            <div class="mb-3 mt-3">
